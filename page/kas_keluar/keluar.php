<div class="row">
                <div class="col-md-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a id="edit_data" data-toggle="modal" data-target="#edit" data-id="<?php echo $data['kode'] ?>" 
                                                data-ket="<?php echo $data['keterangan'] ?>" data-tgl="<?php echo $data['tgl']; ?>" data-jml="<?php echo $data['keluar'] ?>"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">FormTambah Data</h4>
                                        </div>
                    ...
                    if (isset($_POST['simpan'])) {
                        ...
                        $sql = $koneksi->query("INSERT INTO kas (kode,keterangan,tgl,jumlah,jenis,keluar)Values
                        ('$kode','$ket','$tgl',0,'keluar','$jml')");
     ...
     if (isset($_POST['ubah'])) {
        ...
        $sql = $koneksi->query("UPDATE kas set 
        keterangan='$ket',tgl='$tgl',jumlah=0,jenis='keluar',keluar='$jml' WHERE kode='$kode'");
